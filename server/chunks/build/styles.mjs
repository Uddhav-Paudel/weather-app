...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.1hfQS-2C.mjs').then(interopDefault),
  ...
  "layouts/default.vue": () => import('./default-styles.CzIFrobk.mjs').then(interopDefault),
  "layouts/default.vue?vue&type=style&index=0&scoped=63d7675b&lang.scss": () => import('./default-styles.CcxQR4nz.mjs').then(interopDefault)
};
