import { Fragment, reactive, computed, watchEffect, toRefs, capitalize, shallowRef, readonly, warn, getCurrentInstance as getCurrentInstance$1, ref, unref, provide, defineComponent as defineComponent$1, createVNode, mergeProps, inject as inject$1, version as version$1, h, toRaw, isRef, isReactive, toRef, toValue, createElementBlock, watch, onScopeDispose, Suspense, nextTick, Transition, useSSRContext, hasInjectionContext, onServerPrefetch, effectScope, createApp, shallowReactive, getCurrentScope, onErrorCaptured, resolveDynamicComponent, defineAsyncComponent, isReadonly, markRaw, isShallow } from 'vue';
import { $ as $fetch, w as withQuery, l as hasProtocol, m as isScriptProtocol, n as joinURL, o as hash, p as sanitizeStatusCode, q as createHooks, h as createError$1, t as toRouteMatcher, r as createRouter$1, v as defu } from '../runtime.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dw1JYn_U.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-Mev6jhTY.mjs').then((m) => m.default || m)
};
...
const useSettingStore = defineStore("setting", () => {
  const temperature_unit = ref("celsius");
...
const useForecastStore = defineStore("forecaststore", () => {
  const settingStore = useSettingStore();
  const latitude = ref(35.789);
  const longitude = ref(36.678);
  ...
  const apiUrl = ref("https://api.open-meteo.com/v1/forecast");
  const { data, error: err, status, refresh } = useFetch(() => {
    return apiUrl.value;
  }, {
    params: {
      latitude,
...
const useSetting = () => {
  ...
  const toggeleUnit = () => {
    ...
    console.log(temperature_unit.value);
  };
  return { temperature_unit, themeSetting, toggleTheme, toggeleUnit, tabs, innerTabs };
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dbaw9eLK.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DaPf-HeV.mjs').then((r) => r.default || r));
...
export { findChildrenWithProvide as $, useToggleScope as A, only as B, filterInputAttrs as C, callEvent as D, EventProp as E, defineComponent as F, deprecate as G, deepEqual as H, IconValue as I, focusChild as J, getPropertyFromItem as K, omit as L, breakpoints as M, useSetting as N, includes as O, templateRef as P, destructComputed as Q, isCssColor as R, isParsableColor as S, parseColor as T, getForeground as U, useIcon as V, flattenFragments as W, clamp as X, hasEvent as Y, isObject as Z, keyCodes as _, navigateTo as a, consoleWarn as a0, keys as a1, eagerComputed as a2, makeDisplayProps as a3, useDisplay as a4, useGoTo as a5, focusableChildren as a6, PageRouteSymbol as a7, useNuxtApp as a8, LayoutMetaSymbol as a9, generateRouteKey$1 as aa, appPageTransition as ab, appKeepalive as ac, _wrapIf as ad, wrapInKeepAlive as ae, toArray as af, useRuntimeConfig as b, useForecastStore as c, defineStore as d, entry$1 as default, useFetch as e, useSettingStore as f, genericComponent as g, propsFactory as h, injectHead as i, provideTheme as j, useLocale as k, getCurrentInstanceName as l, makeThemeProps as m, nuxtLinkDefaults as n, useProxiedModel as o, provideDefaults as p, useRtl as q, resolveUnrefHeadInput as r, storeToRefs as s, getUid as t, useRouter as u, convertToUnit as v, isOn as w, pick$1 as x, wrapInArray as y, getCurrentInstance as z };
